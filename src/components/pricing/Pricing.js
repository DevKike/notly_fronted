const Pricing = () => {
  return <section className="bsb-pricing-2 bg-light py-5 py-xl-8">
      ...
      <div className="row justify-content-md-center">
        <div className="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
          ...
          <h2 className="display-5 mb-4 mb-md-5 text-center">
            Ofrecemos planes para todos los tipos de usuarios.
          </h2>
      ...
      <div className="row gy-5 gy-lg-0 gx-xl-5">
        <div className="col-12 col-lg-4">
          <div className="card border-0 border-bottom border-primary shadow-sm">
            <div className="card-body p-4 p-xxl-5 animation">
              <h2 className="h4 mb-2">Basico</h2>
              <h4 className="display-3 fw-bold text-primary mb-0">$45</h4>
              <p className="text-secondary mb-4">USD / Mensual</p>
              <ul className="list-group list-group-flush mb-4">
                <li className="list-group-item">
                  ...
                  <span>
                    <strong>Notas</strong> ilimitadas
                  </span>
                </li>
                <li className="list-group-item">
                  <svg
              ...
              <a href="/" className="btn bsb-btn-xl btn-success rounded-pill">
                Escoge plan
              </a>
            </div>
          </div>
        ...
        <div className="col-12 col-lg-4">
          <div className="card border-0 border-bottom border-primary shadow-sm">
            <div className="card-body p-4 p-xxl-5">
              <h2 className="h4 mb-2">Master</h2>
